...
def main() -> None:
    ...
    # Pattern from: Lab 7 Lab7_5.ipynb - GCS file path usage (`gs://bucket-name/file.csv`)
    ...
    # Pattern from: Lab 8 BasicDF_1.ipynb (`where`, `isin`, comparison ops)
    ...
    # Pattern from: Lab 8 cells 487–520 (`date_format`, `year`, `month`, `dayofweek`, `hour`)
